...
## 🚀 News
- **2024/6/17**: Amphion has a new release for its VALLE models, it uses Llama as its underlying architecture, and has better model performance, faster training speed, and more readable codes compared to our first version. [![readme](https://img.shields.io/badge/README-Key%20Features-blue)](egs/tts/valle_v2/README.md)
...
- [SpeechTokenizer](https://github.com/ZhangXInFD/SpeechTokenizer) for semantic-distilled tokenizer design in our new VALLE codes.

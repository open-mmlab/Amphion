...
## 🚀 News
- **2024/06/28**: **Emilia**, a dataset containing 101k hours of speech in six languages, has been released. It features diverse speech with varied speaking styles. Additionally, the automatic Emilia-Pipe tool, which transforms in-the-wild speech data into high-quality training data with annotations for speech generation, is now available!

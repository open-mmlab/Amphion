...
#加载拼音词典
word_pinyin_dict = {}
with open(r"./models/tts/maskgct/g2p/sources/chinese_lexicon.txt", "r", encoding="utf-8") as fread:
...
with open(r"./models/tts/maskgct/g2p/sources/pinyin_2_bpmf.txt", "r", encoding="utf-8") as fread:
    txt_list = fread.readlines()
    for txt in txt_list:
...
tone_dict = {"0":"˙", "5":"˙", "1":"", "2":"ˊ", "3":"ˇ", "4":"ˋ", }

#加载bpmf转pinyin的词典
bopomofos2pinyin_dict = {}
with open(r"./models/tts/maskgct/g2p/sources/bpmf_2_pinyin.txt", "r", encoding="utf-8") as fread:
    txt_list = fread.readlines()
    for txt in txt_list:
        v, k = txt.strip().split("\t")

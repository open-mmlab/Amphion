...
if __name__ == "__main__":
    ...
    parser.add_argument("--src_path", type=str, default=r"data\VCTK\test_data", help="path to src audio files")
    parser.add_argument("--tgt_path", type=str, default=r"data\VCTK\test_output", help="path to output audio files")
    parser.add_argument("--output_path", type=str, default=r"result\pcc.txt", help="path tot the pcc output file")
    ...
    for filename in src_files:
        ...
        path_of_res_audio = os.path.join(args.tgt_path, os.path.splitext(filename)[0]+"_sync.wav")
